...
class TweetMedia:
    ...
    url: str = ""
    media_url: str = ""  # 图片直接 URL
    video_url: str = ""  # 视频 URL (最高码率)
    alt_text: str = ""
    width: int = 0
    height: int = 0
    ...
    def from_media_entity(cls, media: Dict[str, Any]) -> "TweetMedia":
        """从 extended_entities.media 解析媒体"""
...
class TweetData:
    ...
    id: str = ""
    text: str = ""
    full_text: str = ""  # 完整文本 (可能来自 note_tweet 或 article)
    created_at: str = ""
    ...
    def from_tweet_result(cls, tweet_result: Dict[str, Any]) -> "TweetData":
        ...
        # 提取文本内容 (优先级: article > note_tweet > full_text)
